...
<head>
  ...
  <title>Immersion Realms — Reviews</title>
  <meta name="description" content="Stylized review hub for manhua, donghua, cosplayers, and video games. Xianxia + sci‑fi HUD UI."/>
  <meta name="theme-color" content="#00f0ff" />
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <!-- Tech mono + elegant display -->
  ...
  <style>
    ...
    :root {
      ...
      --border: #1e3244;
      --accent: #00f0ff;         /* Jade/Neon */
      --accent-2: #24ffd4;       /* Jade-green */
      --gold: #f7c66b;           /* Alt */
      --danger: #ff4d6d;
      --ok: #00d38d;
    ...
    * { box-sizing: border-box; }
    ...
    body {
      ...
      color: var(--text);
      background: radial-gradient(1200px 800px at 70% 30%, #0b1423, var(--bg) 60%);
      overflow-x: hidden;
    }
    ...
    /* Canvas background under everything */
    #qi-canvas {
